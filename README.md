...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,673 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [The Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,547 | 🐛 73 | 📅 2026-07-20
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,902 | 🐛 155 | 🌐 Ruby | 📅 2026-09-15 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 639 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-15 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,998 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 — remote multi-server automation tool.
* [Chef](https://github.com/opscode/chef) ⭐ 8,236 | 🐛 406 | 🌐 Ruby | 📅 2026-09-15 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,514 | 🐛 338 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
...
* [Savon](https://github.com/savonrb/savon) ⭐ 2,084 | 🐛 9 | 🌐 Ruby | 📅 2026-09-10 — A micro-framework to handle all SOAP (WSDL) requests.
...
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,682 | 🐛 91 | 🌐 Ruby | 📅 2026-09-08 — a continuation of the discontinued [CanCan](https://github.com/ryanb/cancan) ⚠️ Archived project. Our mission is to keep CanCan alive and moving forward, with maintenance fixes and new features.
...
* [que](https://github.com/chanks/que) ⭐ 2,326 | 🐛 60 | 🌐 Ruby | 📅 2026-09-08 — a Ruby job queue that uses PostgreSQL's advisory locks for speed and reliability.
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,252 | 🐛 80 | 🌐 Ruby | 📅 2026-09-13 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [twitter-bootstrap-rails](https://github.com/seyhunak/twitter-bootstrap-rails) ⭐ 4,465 | 🐛 0 | 🌐 HTML | 📅 2026-08-02 — Twitter Bootstrap for Rails asset pipeline.
...
* [SASS](https://github.com/sass/sass) ⭐ 15,373 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-15 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* ★ [dotenv](https://github.com/bkeepers/dotenv) ⭐ 6,762 | 🐛 18 | 🌐 Ruby | 📅 2026-06-22 — loads environment variables from .env file into ENV in development.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,327 | 🐛 94 | 🌐 Ruby | 📅 2026-09-15 — An open source ecommerce solution built with Ruby on Rails.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,586 | 🐛 134 | 🌐 Ruby | 📅 2026-09-15 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [redcarpet](https://github.com/vmg/redcarpet) ⭐ 5,077 | 🐛 123 | 🌐 C | 📅 2025-03-06 — a fast, safe and extensible Markdown to (X)HTML parser.
...
* [Rubyzip](https://github.com/rubyzip/rubyzip) ⭐ 1,428 | 🐛 20 | 🌐 Ruby | 📅 2026-09-14 — A library for reading and writing zip files.
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 41 | 🌐 Ruby | 📅 2026-09-15 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Better Errors](https://github.com/charliesome/better_errors) ⭐ 6,860 | 🐛 68 | 🌐 Ruby | 📅 2024-07-09 — replaces the standard Rails error page with a much better and more useful error page. It is also usable outside of Rails in any Rack app as Rack middleware.
...
* [font-awesome-rails](https://github.com/bokmann/font-awesome-rails) ⭐ 1,851 | 🐛 12 | 🌐 HTML | 📅 2025-01-03 — the [Font Awesome](http://fortawesome.github.io/Font-Awesome/) font bundled as an asset for the rails asset pipeline.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,856 | 🐛 81 | 🌐 Ruby | 📅 2026-09-15 — a Ruby wrapper for crond, with a clear syntax (each job is a separate process).
...
* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,270 | 🐛 118 | 🌐 Ruby | 📅 2026-08-13 — a static analysis security vulnerability scanner for Ruby on Rails applications.
* [Rack::Attack](https://github.com/rack/rack-attack) ⭐ 5,761 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 – Rack middleware for blocking & throttling.
...
* [aasm](https://github.com/aasm/aasm) ⭐ 5,232 | 🐛 167 | 🌐 Ruby | 📅 2026-07-05 — finite state machines to Ruby classes.
...
* [pygments.rb](https://github.com/tmm1/pygments.rb) ⭐ 583 | 🐛 1 | 🌐 Ruby | 📅 2026-09-14 — a Ruby wrapper for the Python [pygments](http://pygments.org) syntax highlighter.
...
* [Faker](https://github.com/stympy/faker) ⭐ 11,937 | 🐛 35 | 🌐 Ruby | 📅 2026-09-11 — a library for generating fake data such as names, addresses, and phone numbers.
...
* [Hanami](https://github.com/hanami/hanami) ⭐ 6,411 | 🐛 36 | 🌐 Ruby | 📅 2026-09-12 — a complete, modern web framework.
