...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,643 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,894 | 🐛 154 | 🌐 Ruby | 📅 2026-09-02 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 639 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-02 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,914 | 🐛 107 | 🌐 Ruby | 📅 2026-09-01 — a Ruby web server built for concurrency.
...
* [Chef](https://github.com/opscode/chef) ⭐ 8,232 | 🐛 409 | 🌐 Ruby | 📅 2026-09-01 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,479 | 🐛 336 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
* [Foreman](https://github.com/ddollar/foreman) ⭐ 6,159 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 — manage Procfile-based applications.
...
* [Annotate](https://github.com/ctran/annotate_models) ⭐ 4,480 | 🐛 144 | 🌐 Ruby | 📅 2024-08-05 — Add a comment summarizing the current schema to the top or bottom of each of your ActiveRecord models, fixtures, tests and specs, factory\_girl factories, routes.rb file, etc.
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,004 | 🐛 237 | 🌐 Ruby | 📅 2026-09-02 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Savon](https://github.com/savonrb/savon) ⭐ 2,085 | 🐛 11 | 🌐 Ruby | 📅 2026-09-02 — A micro-framework to handle all SOAP (WSDL) requests.
* [Committee](https://github.com/interagent/committee) ⭐ 954 | 🐛 32 | 🌐 Ruby | 📅 2026-08-14 — A collection of middleware to help build services with JSON Schema, OpenAPI 2, and OpenAPI 3.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,479 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 — a Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,255 | 🐛 79 | 🌐 Ruby | 📅 2026-09-02 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [colorize](https://github.com/fazibear/colorize) ⭐ 1,284 | 🐛 4 | 🌐 Ruby | 📅 2024-05-21 — String class extension. It adds some methods to set color, background color and text effect on console easier using ANSI escape sequences.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,324 | 🐛 109 | 🌐 Ruby | 📅 2026-09-02 — An open source ecommerce solution built with Ruby on Rails.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 134 | 🌐 Ruby | 📅 2026-09-02 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [markup](https://github.com/github/markup) ⭐ 6,047 | 🐛 25 | 🌐 Ruby | 📅 2026-07-29 — the code GitHub uses to render `README.your_favorite_markup`.
...
* [EventMachine](https://github.com/eventmachine/eventmachine) ⭐ 4,276 | 🐛 199 | 🌐 Ruby | 📅 2026-07-24 — A fast, simple event-processing library.
...
* [Rubyzip](https://github.com/rubyzip/rubyzip) ⭐ 1,427 | 🐛 22 | 🌐 Ruby | 📅 2026-09-01 — A library for reading and writing zip files.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,333 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — a gem to help to increase application's performance by reducing the number of queries it makes. It will watch your queries while you develop your application and notify you when you should add eager loading (N+1 queries), when you're using eager loading that isn't necessary and when you should use counter cache.
...
* [Peek](https://github.com/peek/peek) ⭐ 3,171 | 🐛 18 | 🌐 Ruby | 📅 2024-04-26 — status bar showing performance info for Rails apps.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 202 | 🌐 Ruby | 📅 2026-08-30 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [High Voltage](https://github.com/thoughtbot/high_voltage) ⭐ 3,235 | 🐛 1 | 🌐 Ruby | 📅 2026-06-22 — easily include static pages in your Rails app.
...
* [YamlDb](https://github.com/ludicast/yaml_db) ⭐ 948 | 🐛 43 | 🌐 Ruby | 📅 2021-12-23 — a database-independent format for dumping and restoring data. It complements the the database-independent schema format found in db/schema.rb. The data is saved into db/data.yml.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,857 | 🐛 84 | 🌐 Ruby | 📅 2026-07-01 — a Ruby wrapper for crond, with a clear syntax (each job is a separate process).
...
* [Ransack](https://github.com/activerecord-hackery/ransack) ⭐ 5,860 | 🐛 156 | 🌐 Ruby | 📅 2026-05-31 — enables the creation of both simple and advanced search forms against your application's models.
...
* [JSON](https://github.com/flori/json) ⭐ 781 | 🐛 9 | 🌐 Ruby | 📅 2026-08-27 — includes pure Ruby and C implementation for JSON.
...
* [TOML](https://github.com/jm/toml) ⭐ 156 | 🐛 27 | 🌐 Ruby | 📅 2022-04-21 — a sane configuration format [from @mojombo](https://github.com/toml-lang/toml) ⭐ 20,598 | 🐛 8 | 📅 2026-08-30.
...
* [Rouge](https://github.com/jneen/rouge) ⭐ 3,449 | 🐛 219 | 🌐 Ruby | 📅 2026-08-28 — a pure-ruby code highlighter that is compatible with pygments.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,270 | 🐛 66 | 🌐 Ruby | 📅 2026-09-01 — Rails integration for RSpec.
