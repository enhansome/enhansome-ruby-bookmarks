...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,898 | 🐛 157 | 🌐 Ruby | 📅 2026-08-31 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 639 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-31 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,916 | 🐛 102 | 🌐 Ruby | 📅 2026-08-29 — a Ruby web server built for concurrency.
...
* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,988 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 — remote multi-server automation tool.
* [Chef](https://github.com/opscode/chef) ⭐ 8,232 | 🐛 410 | 🌐 Ruby | 📅 2026-08-31 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,475 | 🐛 336 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
* [Foreman](https://github.com/ddollar/foreman) ⭐ 6,158 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 — manage Procfile-based applications.
* [Reek](https://github.com/troessner/reek) ⭐ 4,129 | 🐛 55 | 🌐 Ruby | 📅 2026-08-28 — code smell detection for Ruby.
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,005 | 🐛 240 | 🌐 Ruby | 📅 2026-08-31 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Pliny](https://github.com/interagent/pliny) ⭐ 808 | 🐛 19 | 🌐 Ruby | 📅 2026-04-29 – write excellent APIs in Ruby.

### Authentication

* [Devise](https://github.com/plataformatec/devise) ⭐ 24,357 | 🐛 233 | 🌐 Ruby | 📅 2026-06-22 — flexible authentication solution for Rails with Warden.
...
* [Pundit](https://github.com/elabs/pundit) ⭐ 8,521 | 🐛 13 | 🌐 Ruby | 📅 2026-08-28 — minimal authorization through OO design and pure Ruby classes.
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,685 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 — a continuation of the discontinued [CanCan](https://github.com/ryanb/cancan) ⚠️ Archived project. Our mission is to keep CanCan alive and moving forward, with maintenance fixes and new features.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,480 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 — a Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,256 | 🐛 79 | 🌐 Ruby | 📅 2026-08-31 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [SASS](https://github.com/sass/sass) ⭐ 15,371 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-25 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* ★ [dotenv](https://github.com/bkeepers/dotenv) ⭐ 6,763 | 🐛 17 | 🌐 Ruby | 📅 2026-06-22 — loads environment variables from .env file into ENV in development.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,326 | 🐛 109 | 🌐 Ruby | 📅 2026-08-28 — An open source ecommerce solution built with Ruby on Rails.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,582 | 🐛 133 | 🌐 Ruby | 📅 2026-08-31 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [markup](https://github.com/github/markup) ⭐ 6,045 | 🐛 25 | 🌐 Ruby | 📅 2026-07-29 — the code GitHub uses to render `README.your_favorite_markup`.
...
* [Rubyzip](https://github.com/rubyzip/rubyzip) ⭐ 1,427 | 🐛 23 | 🌐 Ruby | 📅 2026-08-31 — A library for reading and writing zip files.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,335 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — a gem to help to increase application's performance by reducing the number of queries it makes. It will watch your queries while you develop your application and notify you when you should add eager loading (N+1 queries), when you're using eager loading that isn't necessary and when you should use counter cache.
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,776 | 🐛 50 | 🌐 Ruby | 📅 2026-08-30 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Better Errors](https://github.com/charliesome/better_errors) ⭐ 6,861 | 🐛 68 | 🌐 Ruby | 📅 2024-07-09 — replaces the standard Rails error page with a much better and more useful error page. It is also usable outside of Rails in any Rack app as Rack middleware.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,859 | 🐛 84 | 🌐 Ruby | 📅 2026-07-01 — a Ruby wrapper for crond, with a clear syntax (each job is a separate process).
...
* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,265 | 🐛 116 | 🌐 Ruby | 📅 2026-08-13 — a static analysis security vulnerability scanner for Ruby on Rails applications.
* [Rack::Attack](https://github.com/rack/rack-attack) ⭐ 5,764 | 🐛 19 | 🌐 Ruby | 📅 2026-07-02 – Rack middleware for blocking & throttling.
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 – Patch-level verification for Bundler.
...
* [aasm](https://github.com/aasm/aasm) ⭐ 5,229 | 🐛 166 | 🌐 Ruby | 📅 2026-07-05 — finite state machines to Ruby classes.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 68 | 🌐 Ruby | 📅 2026-08-27 — Rails integration for RSpec.
...
* [RSpec](https://github.com/rspec/rspec) ⭐ 114 | 🐛 169 | 🌐 Ruby | 📅 2026-08-28 — RSpec meta-gem that depends on the other components.
