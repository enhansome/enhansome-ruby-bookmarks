...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,686 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [Ruby Cheatsheet](https://github.com/lifeparticle/Ruby-Cheatsheet) ⭐ 218 | 🐛 6 | 🌐 Ruby | 📅 2026-09-24 — A cheatsheet for beginners.
...
* [Thoughtbot Style Guides](https://github.com/thoughtbot/guides) ⭐ 9,564 | 🐛 10 | 🌐 Ruby | 📅 2026-08-21 (Ruby, Rails, Git, and some other technologies)
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,904 | 🐛 147 | 🌐 Ruby | 📅 2026-09-24 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,918 | 🐛 113 | 🌐 Ruby | 📅 2026-09-16 — a Ruby web server built for concurrency.
...
* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 13,003 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 — remote multi-server automation tool.
* [Chef](https://github.com/opscode/chef) ⭐ 8,243 | 🐛 413 | 🌐 Ruby | 📅 2026-09-24 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,576 | 🐛 337 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,008 | 🐛 242 | 🌐 Ruby | 📅 2026-09-24 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Savon](https://github.com/savonrb/savon) ⭐ 2,086 | 🐛 9 | 🌐 Ruby | 📅 2026-09-22 — A micro-framework to handle all SOAP (WSDL) requests.
* [Committee](https://github.com/interagent/committee) ⭐ 955 | 🐛 35 | 🌐 Ruby | 📅 2026-09-24 — A collection of middleware to help build services with JSON Schema, OpenAPI 2, and OpenAPI 3.
* [Pliny](https://github.com/interagent/pliny) ⭐ 808 | 🐛 19 | 🌐 Ruby | 📅 2026-04-29 – write excellent APIs in Ruby.

### Authentication

* [Devise](https://github.com/plataformatec/devise) ⭐ 24,354 | 🐛 235 | 🌐 Ruby | 📅 2026-06-22 — flexible authentication solution for Rails with Warden.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,252 | 🐛 81 | 🌐 Ruby | 📅 2026-09-24 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [colorize](https://github.com/fazibear/colorize) ⭐ 1,285 | 🐛 4 | 🌐 Ruby | 📅 2024-05-21 — String class extension. It adds some methods to set color, background color and text effect on console easier using ANSI escape sequences.

### CSS

* [SASS](https://github.com/sass/sass) ⭐ 15,374 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-23 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,333 | 🐛 71 | 🌐 Ruby | 📅 2026-09-23 — An open source ecommerce solution built with Ruby on Rails.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,591 | 🐛 134 | 🌐 Ruby | 📅 2026-09-20 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [Pony](https://github.com/benprew/pony) ⭐ 1,131 | 🐛 1 | 🌐 Ruby | 📅 2025-04-08 — the express way to send email in Ruby.
...
* [markup](https://github.com/github/markup) ⭐ 6,042 | 🐛 26 | 🌐 Ruby | 📅 2026-09-23 — the code GitHub uses to render `README.your_favorite_markup`.
...
* [Dalli](https://github.com/mperham/dalli) ⭐ 3,114 | 🐛 3 | 🌐 Ruby | 📅 2026-09-24 — A high performance Memcached client for Ruby.
...
* [Parallel](https://github.com/grosser/parallel) ⭐ 4,266 | 🐛 37 | 🌐 Ruby | 📅 2026-09-06 — Run any code in parallel Processes(> use all CPUs) or Threads(> speedup blocking operations).
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,773 | 🐛 36 | 🌐 Ruby | 📅 2026-09-24 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,955 | 🐛 128 | 🌐 Ruby | 📅 2026-09-24 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [suspenders](https://github.com/thoughtbot/suspenders) ⭐ 4,042 | 🐛 1 | 🌐 Ruby | 📅 2026-09-23 — a Rails template with [Thoughtbot](http://thoughtbot.com) standard defaults, ready to deploy to Heroku.
...
* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,273 | 🐛 120 | 🌐 Ruby | 📅 2026-09-22 — a static analysis security vulnerability scanner for Ruby on Rails applications.
* [Rack::Attack](https://github.com/rack/rack-attack) ⭐ 5,763 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 – Rack middleware for blocking & throttling.
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,760 | 🐛 50 | 🌐 Ruby | 📅 2026-09-22 – Patch-level verification for Bundler.
...
* [OJ](https://github.com/ohler55/oj) ⭐ 3,224 | 🐛 15 | 🌐 C | 📅 2026-09-10 — Optimized JSON, as the name implies, was written to provide speed optimized JSON handling. So far it has achieved that, and is about 2 times faster than any other Ruby JSON parser, and 3 or more times faster at serializing JSON.
...
* [TOML](https://github.com/jm/toml) ⭐ 156 | 🐛 27 | 🌐 Ruby | 📅 2022-04-21 — a sane configuration format [from @mojombo](https://github.com/toml-lang/toml) ⭐ 20,623 | 🐛 7 | 📅 2026-09-15.
...
* [aasm](https://github.com/aasm/aasm) ⭐ 5,232 | 🐛 169 | 🌐 Ruby | 📅 2026-07-05 — finite state machines to Ruby classes.
...
* [Rouge](https://github.com/jneen/rouge) ⭐ 3,452 | 🐛 222 | 🌐 Ruby | 📅 2026-09-22 — a pure-ruby code highlighter that is compatible with pygments.
...
* [Hanami](https://github.com/hanami/hanami) ⭐ 6,415 | 🐛 37 | 🌐 Ruby | 📅 2026-09-20 — a complete, modern web framework.
