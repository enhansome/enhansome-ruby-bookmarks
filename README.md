...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,659 | 🐛 63 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [The Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,545 | 🐛 73 | 📅 2026-07-20
* [Thoughtbot Style Guides](https://github.com/thoughtbot/guides) ⭐ 9,560 | 🐛 11 | 🌐 Ruby | 📅 2026-08-21 (Ruby, Rails, Git, and some other technologies)
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,895 | 🐛 155 | 🌐 Ruby | 📅 2026-09-08 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 639 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-08 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [chruby](https://github.com/postmodern/chruby) ⭐ 2,911 | 🐛 99 | 🌐 Shell | 📅 2025-10-27 — A tool that changes the current Ruby.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,914 | 🐛 110 | 🌐 Ruby | 📅 2026-09-03 — a Ruby web server built for concurrency.
...
* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,993 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 — remote multi-server automation tool.
* [Chef](https://github.com/opscode/chef) ⭐ 8,235 | 🐛 408 | 🌐 Ruby | 📅 2026-09-07 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,486 | 🐛 338 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
* [Foreman](https://github.com/ddollar/foreman) ⭐ 6,160 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 — manage Procfile-based applications.
...
* [Awesome Ruby Security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 473 | 🐛 1 | 📅 2024-02-22
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,007 | 🐛 238 | 🌐 Ruby | 📅 2026-09-08 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Committee](https://github.com/interagent/committee) ⭐ 954 | 🐛 31 | 🌐 Ruby | 📅 2026-09-07 — A collection of middleware to help build services with JSON Schema, OpenAPI 2, and OpenAPI 3.
...
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,683 | 🐛 91 | 🌐 Ruby | 📅 2026-09-08 — a continuation of the discontinued [CanCan](https://github.com/ryanb/cancan) ⚠️ Archived project. Our mission is to keep CanCan alive and moving forward, with maintenance fixes and new features.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,254 | 🐛 80 | 🌐 Ruby | 📅 2026-09-08 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [bootstrap-sass](https://github.com/twbs/bootstrap-sass) ⭐ 12,495 | 🐛 31 | 🌐 SCSS | 📅 2026-01-03 — official SASS port of Twitter Bootstrap.
* [twitter-bootstrap-rails](https://github.com/seyhunak/twitter-bootstrap-rails) ⭐ 4,466 | 🐛 0 | 🌐 HTML | 📅 2026-08-02 — Twitter Bootstrap for Rails asset pipeline.
...
* [SASS](https://github.com/sass/sass) ⭐ 15,371 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-04 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,325 | 🐛 91 | 🌐 Ruby | 📅 2026-09-07 — An open source ecommerce solution built with Ruby on Rails.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,582 | 🐛 134 | 🌐 Ruby | 📅 2026-09-07 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [Mail](https://github.com/mikel/mail) ⭐ 3,670 | 🐛 214 | 🌐 Ruby | 📅 2026-07-01 — a library that is designed to handle emails generation, parsing and sending in a simple, rubyesque manner.
...
* [Mailgun-Ruby](https://github.com/mailgun/mailgun-ruby) ⭐ 489 | 🐛 2 | 🌐 Ruby | 📅 2026-06-26 — Mailgun's Official Ruby Library.
...
* [Prawn](https://github.com/prawnpdf/prawn) ⭐ 4,821 | 🐛 93 | 🌐 Ruby | 📅 2026-04-18 — fast, nimble PDF generation.
...
* [Dalli](https://github.com/mperham/dalli) ⭐ 3,112 | 🐛 3 | 🌐 Ruby | 📅 2026-08-16 — A high performance Memcached client for Ruby.
* [rpush](https://github.com/rpush/rpush) ⭐ 2,203 | 🐛 39 | 🌐 Ruby | 📅 2025-07-01 — push notification service, supporting Apple Push Notification Service, Google Cloud Messaging, Amazon Device Messaging, Windows Phone Push Notification Service.
...
* [twig](https://github.com/rondevera/twig) ⭐ 273 | 🐛 12 | 🌐 Ruby | 📅 2016-03-20 — Your personal Git branch assistant
...
* [Parallel](https://github.com/grosser/parallel) ⭐ 4,264 | 🐛 37 | 🌐 Ruby | 📅 2026-09-06 — Run any code in parallel Processes(> use all CPUs) or Threads(> speedup blocking operations).
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,337 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — a gem to help to increase application's performance by reducing the number of queries it makes. It will watch your queries while you develop your application and notify you when you should add eager loading (N+1 queries), when you're using eager loading that isn't necessary and when you should use counter cache.
...
* [rack-mini-profiler](https://github.com/MiniProfiler/rack-mini-profiler) ⭐ 3,905 | 🐛 38 | 🌐 Ruby | 📅 2026-08-21 — middleware that displays speed badge for every html page. Designed to work both in production and in development.
* [Coverband](https://github.com/danmayer/coverband) ⭐ 2,689 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 — Rack middleware to help measure production code coverage.
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,775 | 🐛 42 | 🌐 Ruby | 📅 2026-09-07 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
* [Simple Form](https://github.com/plataformatec/simple_form) ⭐ 8,228 | 🐛 38 | 🌐 Ruby | 📅 2026-04-01 — forms made easy for Rails! It's tied to a simple DSL, with no opinion on markup.
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,957 | 🐛 197 | 🌐 Ruby | 📅 2026-09-07 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,267 | 🐛 117 | 🌐 Ruby | 📅 2026-08-13 — a static analysis security vulnerability scanner for Ruby on Rails applications.
...
* [OJ](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 18 | 🌐 C | 📅 2026-09-06 — Optimized JSON, as the name implies, was written to provide speed optimized JSON handling. So far it has achieved that, and is about 2 times faster than any other Ruby JSON parser, and 3 or more times faster at serializing JSON.
...
* [JSON](https://github.com/flori/json) ⭐ 781 | 🐛 9 | 🌐 Ruby | 📅 2026-09-08 — includes pure Ruby and C implementation for JSON.
...
* [TOML](https://github.com/jm/toml) ⭐ 156 | 🐛 27 | 🌐 Ruby | 📅 2022-04-21 — a sane configuration format [from @mojombo](https://github.com/toml-lang/toml) ⭐ 20,609 | 🐛 8 | 📅 2026-09-02.
...
* [aasm](https://github.com/aasm/aasm) ⭐ 5,233 | 🐛 166 | 🌐 Ruby | 📅 2026-07-05 — finite state machines to Ruby classes.
...
* [factory\_bot](https://github.com/thoughtbot/factory_bot) ⭐ 8,170 | 🐛 80 | 🌐 Ruby | 📅 2026-08-21 — a fixtures replacement with a straightforward definition syntax, support for multiple build strategies (saved instances, unsaved instances, attribute hashes, and stubbed objects), and support for multiple factories for the same class, including factory inheritance.
...
* [Hanami](https://github.com/hanami/hanami) ⭐ 6,406 | 🐛 35 | 🌐 Ruby | 📅 2026-09-08 — a complete, modern web framework.
