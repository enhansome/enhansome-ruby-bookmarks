...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,638 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [Ruby Cheatsheet](https://github.com/lifeparticle/Ruby-Cheatsheet) ⭐ 219 | 🐛 6 | 🌐 Ruby | 📅 2026-08-27 — A cheatsheet for beginners.
...
* [The Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,547 | 🐛 74 | 📅 2026-07-20
...
* [The Rails Style Guide](https://github.com/bbatsov/rails-style-guide) ⭐ 6,505 | 🐛 44 | 📅 2026-07-21
...
* ★ [Sublime Text](http://www.sublimetext.com) — one of the best text editors for coding. Take a look at [Sublime Bookmarks](https://github.com/dreikanter/sublime-bookmarks) ⭐ 1,076 | 🐛 1 | 📅 2024-01-15 — a comprehensive list of plugins and other related stuff.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,896 | 🐛 158 | 🌐 Ruby | 📅 2026-09-01 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 639 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-01 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [chruby](https://github.com/postmodern/chruby) ⭐ 2,913 | 🐛 99 | 🌐 Shell | 📅 2025-10-27 — A tool that changes the current Ruby.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,915 | 🐛 102 | 🌐 Ruby | 📅 2026-09-01 — a Ruby web server built for concurrency.
...
* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,989 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 — remote multi-server automation tool.
* [Chef](https://github.com/opscode/chef) ⭐ 8,233 | 🐛 408 | 🌐 Ruby | 📅 2026-09-01 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
* ★ [Mina](https://github.com/mina-deploy/mina) ⭐ 4,354 | 🐛 35 | 🌐 Ruby | 📅 2024-08-01 – really fast deployer and server automation tool.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,477 | 🐛 336 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
* [Foreman](https://github.com/ddollar/foreman) ⭐ 6,158 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 — manage Procfile-based applications.
* [Reek](https://github.com/troessner/reek) ⭐ 4,128 | 🐛 55 | 🌐 Ruby | 📅 2026-08-28 — code smell detection for Ruby.
...
* [Annotate](https://github.com/ctran/annotate_models) ⭐ 4,481 | 🐛 144 | 🌐 Ruby | 📅 2024-08-05 — Add a comment summarizing the current schema to the top or bottom of each of your ActiveRecord models, fixtures, tests and specs, factory\_girl factories, routes.rb file, etc.
...
* [Thinking Sphinx](https://github.com/pat/thinking-sphinx) ⭐ 1,621 | 🐛 18 | 🌐 Ruby | 📅 2026-01-11 — a library for connecting ActiveRecord to the Sphinx full-text search tool, and integrates closely with Rails (but also works with other Ruby web frameworks).
* [pp\_sql](https://github.com/kvokka/pp_sql) ⭐ 274 | 🐛 4 | 🌐 Ruby | 📅 2026-08-23 — Rails ActiveRecord SQL queries log beautifier.

### API

* [Grape](https://github.com/intridea/grape) ⭐ 10,004 | 🐛 239 | 🌐 Ruby | 📅 2026-09-01 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Devise](https://github.com/plataformatec/devise) ⭐ 24,358 | 🐛 233 | 🌐 Ruby | 📅 2026-06-22 — flexible authentication solution for Rails with Warden.
...
* [Authlogic](https://github.com/binarylogic/authlogic) ⭐ 4,343 | 🐛 12 | 🌐 Ruby | 📅 2026-02-08 — a clean, simple, and unobtrusive ruby authentication solution.
...
* [Pundit](https://github.com/elabs/pundit) ⭐ 8,520 | 🐛 13 | 🌐 Ruby | 📅 2026-08-28 — minimal authorization through OO design and pure Ruby classes.
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,684 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 — a continuation of the discontinued [CanCan](https://github.com/ryanb/cancan) ⚠️ Archived project. Our mission is to keep CanCan alive and moving forward, with maintenance fixes and new features.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,481 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 — a Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [que](https://github.com/chanks/que) ⭐ 2,325 | 🐛 59 | 🌐 Ruby | 📅 2026-01-01 — a Ruby job queue that uses PostgreSQL's advisory locks for speed and reliability.
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,256 | 🐛 79 | 🌐 Ruby | 📅 2026-09-01 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [bootstrap-sass](https://github.com/twbs/bootstrap-sass) ⭐ 12,496 | 🐛 31 | 🌐 SCSS | 📅 2026-01-03 — official SASS port of Twitter Bootstrap.
...
* [TTY](https://github.com/peter-murach/tty) ⭐ 2,531 | 🐛 13 | 🌐 Ruby | 📅 2022-12-31 — a toolbox for developing beautiful command line clients in Ruby.
...
* [RMagick](https://github.com/rmagick/rmagick) ⭐ 731 | 🐛 4 | 🌐 C++ | 📅 2026-08-31 — an interface to the ImageMagick and GraphicsMagick image processing libraries.
...
* [Fluentd](https://github.com/fluent/fluentd) ⭐ 13,582 | 🐛 137 | 🌐 Ruby | 📅 2026-09-01 — an open source data collector designed for processing data streams, which instantly enables you to have Log Management, Big Data Analytics, etc.
...
* [Mail](https://github.com/mikel/mail) ⭐ 3,671 | 🐛 214 | 🌐 Ruby | 📅 2026-07-01 — a library that is designed to handle emails generation, parsing and sending in a simple, rubyesque manner.
* [Pony](https://github.com/benprew/pony) ⭐ 1,130 | 🐛 1 | 🌐 Ruby | 📅 2025-04-08 — the express way to send email in Ruby.
* [AWS::SES](https://github.com/drewblas/aws-ses) ⭐ 543 | 🐛 33 | 🌐 Ruby | 📅 2023-01-18 — An easy Ruby DSL & interface to [Amazon SES](http://aws.amazon.com/ses/). See also the [official Ruby SDK](http://aws.amazon.com/sdkforruby/).
...
* [markup](https://github.com/github/markup) ⭐ 6,046 | 🐛 25 | 🌐 Ruby | 📅 2026-07-29 — the code GitHub uses to render `README.your_favorite_markup`.
* [redcarpet](https://github.com/vmg/redcarpet) ⭐ 5,078 | 🐛 123 | 🌐 C | 📅 2025-03-06 — a fast, safe and extensible Markdown to (X)HTML parser.
* [kramdown](https://github.com/gettalong/kramdown) ⭐ 1,781 | 🐛 18 | 🌐 Ruby | 📅 2026-01-31 — A yet-another-markdown-parser but fast, pure Ruby, using a strict syntax definition and supporting several common extensions, <http://kramdown.gettalong.org>
...
* [Prawn](https://github.com/prawnpdf/prawn) ⭐ 4,821 | 🐛 92 | 🌐 Ruby | 📅 2026-04-18 — fast, nimble PDF generation.
* [EventMachine](https://github.com/eventmachine/eventmachine) ⭐ 4,277 | 🐛 199 | 🌐 Ruby | 📅 2026-07-24 — A fast, simple event-processing library.
* [awesome\_print](https://github.com/awesome-print/awesome_print) ⭐ 4,077 | 🐛 110 | 🌐 Ruby | 📅 2024-08-15 — a Ruby library that pretty prints Ruby objects in full color exposing their internal structure with proper indentation. Rails ActiveRecord objects and usage within Rails templates are supported via included mixins.
* [Dalli](https://github.com/mperham/dalli) ⭐ 3,113 | 🐛 4 | 🌐 Ruby | 📅 2026-08-16 — A high performance Memcached client for Ruby.
...
* [Rubyzip](https://github.com/rubyzip/rubyzip) ⭐ 1,426 | 🐛 23 | 🌐 Ruby | 📅 2026-08-31 — A library for reading and writing zip files.
...
* [Parallel](https://github.com/grosser/parallel) ⭐ 4,264 | 🐛 37 | 🌐 Ruby | 📅 2026-08-30 — Run any code in parallel Processes(> use all CPUs) or Threads(> speedup blocking operations).
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,334 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — a gem to help to increase application's performance by reducing the number of queries it makes. It will watch your queries while you develop your application and notify you when you should add eager loading (N+1 queries), when you're using eager loading that isn't necessary and when you should use counter cache.
* [rack-mini-profiler](https://github.com/MiniProfiler/rack-mini-profiler) ⭐ 3,906 | 🐛 38 | 🌐 Ruby | 📅 2026-08-21 — middleware that displays speed badge for every html page. Designed to work both in production and in development.
* [Timecop](https://github.com/travisjeffery/timecop) ⭐ 3,424 | 🐛 11 | 🌐 Ruby | 📅 2026-04-12 — a gem providing "time travel", "time freezing", and "time acceleration" capabilities, making it simple to test time-dependent code. It provides a unified method to mock Time.now, Date.today, and DateTime.now in a single call.
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,776 | 🐛 49 | 🌐 Ruby | 📅 2026-08-30 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,957 | 🐛 202 | 🌐 Ruby | 📅 2026-08-30 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [suspenders](https://github.com/thoughtbot/suspenders) ⭐ 4,042 | 🐛 1 | 🌐 Ruby | 📅 2026-08-28 — a Rails template with [Thoughtbot](http://thoughtbot.com) standard defaults, ready to deploy to Heroku.
* [High Voltage](https://github.com/thoughtbot/high_voltage) ⭐ 3,236 | 🐛 1 | 🌐 Ruby | 📅 2026-06-22 — easily include static pages in your Rails app.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,858 | 🐛 84 | 🌐 Ruby | 📅 2026-07-01 — a Ruby wrapper for crond, with a clear syntax (each job is a separate process).
...
* [sidekiq-cron](https://github.com/ondrejbartas/sidekiq-cron) ⭐ 1,943 | 🐛 3 | 🌐 Ruby | 📅 2026-05-27 — scheduler based on rufus-scheduler and [Sidekiq](http://sidekiq.org) ([Redis](http://redis.io) based message queue) for persistence. Inherits web UI from Sidekiq.
...
* [Square SDK](https://github.com/square/square-ruby-sdk) ⭐ 75 | 🐛 2 | 🌐 Ruby | 📅 2026-08-18 - The Ruby SDK for Square APIs.
...
* [Ransack](https://github.com/activerecord-hackery/ransack) ⭐ 5,861 | 🐛 156 | 🌐 Ruby | 📅 2026-05-31 — enables the creation of both simple and advanced search forms against your application's models.

### Security

* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,266 | 🐛 116 | 🌐 Ruby | 📅 2026-08-13 — a static analysis security vulnerability scanner for Ruby on Rails applications.
* [Rack::Attack](https://github.com/rack/rack-attack) ⭐ 5,760 | 🐛 19 | 🌐 Ruby | 📅 2026-07-02 – Rack middleware for blocking & throttling.
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,756 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 – Patch-level verification for Bundler.
...
* [OJ](https://github.com/ohler55/oj) ⭐ 3,225 | 🐛 14 | 🌐 C | 📅 2026-08-30 — Optimized JSON, as the name implies, was written to provide speed optimized JSON handling. So far it has achieved that, and is about 2 times faster than any other Ruby JSON parser, and 3 or more times faster at serializing JSON.
...
* [JSON](https://github.com/flori/json) ⭐ 782 | 🐛 9 | 🌐 Ruby | 📅 2026-08-27 — includes pure Ruby and C implementation for JSON.
...
* [aasm](https://github.com/aasm/aasm) ⭐ 5,230 | 🐛 166 | 🌐 Ruby | 📅 2026-07-05 — finite state machines to Ruby classes.
* [Statesman](https://github.com/gocardless/statesman) ⭐ 1,907 | 🐛 16 | 🌐 Ruby | 📅 2026-08-04 — an opinionated state machine library designed to provide a robust audit trail and data integrity. It decouples the state machine logic from the underlying model and allows for easy composition with one or more model classes.
* [MicroMachine](https://github.com/soveran/micromachine) ⭐ 523 | 🐛 2 | 🌐 Ruby | 📅 2017-08-20 — minimal Finite State Machine.

### Syntax Highlighters

* [Rouge](https://github.com/jneen/rouge) ⭐ 3,450 | 🐛 219 | 🌐 Ruby | 📅 2026-08-28 — a pure-ruby code highlighter that is compatible with pygments.
* [pygments.rb](https://github.com/tmm1/pygments.rb) ⭐ 583 | 🐛 1 | 🌐 Ruby | 📅 2026-08-27 — a Ruby wrapper for the Python [pygments](http://pygments.org) syntax highlighter.

### Template engines

* [Slim](https://github.com/slim-template/slim) ⭐ 5,375 | 🐛 22 | 🌐 Ruby | 📅 2026-07-24 – a templating language that reduce the syntax to the essential parts without becoming cryptic.
...
* [Faker](https://github.com/stympy/faker) ⭐ 11,933 | 🐛 41 | 🌐 Ruby | 📅 2026-08-31 — a library for generating fake data such as names, addresses, and phone numbers.
* [Capybara](https://github.com/jnicklas/capybara) ⭐ 10,172 | 🐛 22 | 🌐 Ruby | 📅 2026-07-13 — a tool helping you test web applications by simulating how a real user would interact with your app. It is agnostic about the driver running your tests and comes with Rack::Test and Selenium support built in. WebKit is supported through an external gem.
* [factory\_bot](https://github.com/thoughtbot/factory_bot) ⭐ 8,169 | 🐛 79 | 🌐 Ruby | 📅 2026-08-21 — a fixtures replacement with a straightforward definition syntax, support for multiple build strategies (saved instances, unsaved instances, attribute hashes, and stubbed objects), and support for multiple factories for the same class, including factory inheritance.
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 67 | 🌐 Ruby | 📅 2026-09-01 — Rails integration for RSpec.
...
* [RSpec](https://github.com/rspec/rspec) ⭐ 114 | 🐛 167 | 🌐 Ruby | 📅 2026-09-01 — RSpec meta-gem that depends on the other components.

### Web Frameworks

* [Hanami](https://github.com/hanami/hanami) ⭐ 6,406 | 🐛 34 | 🌐 Ruby | 📅 2026-08-31 — a complete, modern web framework.
