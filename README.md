...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,664 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [Thoughtbot Style Guides](https://github.com/thoughtbot/guides) ⭐ 9,562 | 🐛 11 | 🌐 Ruby | 📅 2026-08-21 (Ruby, Rails, Git, and some other technologies)
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,898 | 🐛 147 | 🌐 Ruby | 📅 2026-09-11 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* ★ [rbenv](https://github.com/sstephenson/rbenv) ⭐ 16,730 | 🐛 16 | 🌐 Shell | 📅 2026-07-14 — A tool to pick a Ruby version for your application and guarantee that your development environment matches production. Put rbenv to work with Bundler for painless Ruby upgrades and bulletproof deployments.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,914 | 🐛 111 | 🌐 Ruby | 📅 2026-09-10 — a Ruby web server built for concurrency.
...
* [Chef](https://github.com/opscode/chef) ⭐ 8,236 | 🐛 410 | 🌐 Ruby | 📅 2026-09-10 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,496 | 🐛 338 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,008 | 🐛 251 | 🌐 Ruby | 📅 2026-09-11 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,475 | 🐛 74 | 🌐 Ruby | 📅 2026-09-10 — a Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,254 | 🐛 82 | 🌐 Ruby | 📅 2026-09-11 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [SASS](https://github.com/sass/sass) ⭐ 15,373 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-09 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,327 | 🐛 93 | 🌐 Ruby | 📅 2026-09-11 — An open source ecommerce solution built with Ruby on Rails.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 197 | 🌐 Ruby | 📅 2026-09-11 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [TOML](https://github.com/jm/toml) ⭐ 156 | 🐛 27 | 🌐 Ruby | 📅 2022-04-21 — a sane configuration format [from @mojombo](https://github.com/toml-lang/toml) ⭐ 20,610 | 🐛 6 | 📅 2026-09-10.
...
* [Statesman](https://github.com/gocardless/statesman) ⭐ 1,909 | 🐛 16 | 🌐 Ruby | 📅 2026-08-04 — an opinionated state machine library designed to provide a robust audit trail and data integrity. It decouples the state machine logic from the underlying model and allows for easy composition with one or more model classes.
...
* [Faker](https://github.com/stympy/faker) ⭐ 11,937 | 🐛 34 | 🌐 Ruby | 📅 2026-09-08 — a library for generating fake data such as names, addresses, and phone numbers.
...
* [Hanami](https://github.com/hanami/hanami) ⭐ 6,407 | 🐛 35 | 🌐 Ruby | 📅 2026-09-11 — a complete, modern web framework.
