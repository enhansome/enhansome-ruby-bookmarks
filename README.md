...
PS: Check out [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,688 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 for other community-driven bookmark collections.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,908 | 🐛 149 | 🌐 Ruby | 📅 2026-09-25 — a Ruby static code analyzer, based on the community Ruby style guide.
...
* [sonarlint-intellij](https://github.com/SonarSource/sonarlint-intellij) ⭐ 640 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-25 — An IDE extension that helps you detect and fix quality issues as you write code.
...
* [Puma](https://github.com/puma/puma) ⭐ 7,917 | 🐛 116 | 🌐 Ruby | 📅 2026-09-16 — a Ruby web server built for concurrency.
...
* [Chef](https://github.com/opscode/chef) ⭐ 8,245 | 🐛 412 | 🌐 Ruby | 📅 2026-09-25 — a systems integration framework, built to bring the benefits of configuration management to your entire infrastructure.
...
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,586 | 🐛 337 | 🌐 Python | 📅 2024-12-17 — An extremely handy command-line HTTP client; a user-friendly cURL replacement.
...
* [Ancestry](https://github.com/stefankroes/ancestry) ⭐ 3,881 | 🐛 32 | 🌐 Ruby | 📅 2026-06-25 — Organize ActiveRecord models into a tree structure.
...
* [Grape](https://github.com/intridea/grape) ⭐ 10,007 | 🐛 240 | 🌐 Ruby | 📅 2026-09-25 — an opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [Devise](https://github.com/plataformatec/devise) ⭐ 24,353 | 🐛 235 | 🌐 Ruby | 📅 2026-06-22 — flexible authentication solution for Rails with Warden.
...
* [Karafka](https://github.com/karafka/karafka) ⭐ 2,252 | 🐛 81 | 🌐 Ruby | 📅 2026-09-26 — Ruby and Rails multi-threaded efficient Kafka processing framework. It allows you to capture everything that happens in your systems in large scale.
...
* [SASS](https://github.com/sass/sass) ⭐ 15,375 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-24 — an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [Solidus](https://github.com/solidusio/solidus) ⭐ 5,336 | 🐛 72 | 🌐 Ruby | 📅 2026-09-25 — An open source ecommerce solution built with Ruby on Rails.
...
* [RMagick](https://github.com/rmagick/rmagick) ⭐ 731 | 🐛 5 | 🌐 C++ | 📅 2026-09-23 — an interface to the ImageMagick and GraphicsMagick image processing libraries.
...
* [Mail](https://github.com/mikel/mail) ⭐ 3,670 | 🐛 217 | 🌐 Ruby | 📅 2026-07-01 — a library that is designed to handle emails generation, parsing and sending in a simple, rubyesque manner.
...
* [markup](https://github.com/github/markup) ⭐ 6,041 | 🐛 26 | 🌐 Ruby | 📅 2026-09-23 — the code GitHub uses to render `README.your_favorite_markup`.
...
* [Dalli](https://github.com/mperham/dalli) ⭐ 3,114 | 🐛 4 | 🌐 Ruby | 📅 2026-09-25 — A high performance Memcached client for Ruby.
...
* [Rubyzip](https://github.com/rubyzip/rubyzip) ⭐ 1,429 | 🐛 19 | 🌐 Ruby | 📅 2026-09-26 — A library for reading and writing zip files.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,341 | 🐛 6 | 🌐 Ruby | 📅 2026-08-29 — a gem to help to increase application's performance by reducing the number of queries it makes. It will watch your queries while you develop your application and notify you when you should add eager loading (N+1 queries), when you're using eager loading that isn't necessary and when you should use counter cache.
...
* [CarrierWave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,772 | 🐛 36 | 🌐 Ruby | 📅 2026-09-26 — classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 126 | 🌐 Ruby | 📅 2026-09-26 — a Rails engine that provides an easy-to-use interface for managing your data.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,855 | 🐛 81 | 🌐 Ruby | 📅 2026-09-15 — a Ruby wrapper for crond, with a clear syntax (each job is a separate process).
...
* [Brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,273 | 🐛 114 | 🌐 Ruby | 📅 2026-09-25 — a static analysis security vulnerability scanner for Ruby on Rails applications.
* [Rack::Attack](https://github.com/rack/rack-attack) ⭐ 5,764 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 – Rack middleware for blocking & throttling.
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,760 | 🐛 51 | 🌐 Ruby | 📅 2026-09-25 – Patch-level verification for Bundler.
...
* [OJ](https://github.com/ohler55/oj) ⭐ 3,223 | 🐛 14 | 🌐 C | 📅 2026-09-25 — Optimized JSON, as the name implies, was written to provide speed optimized JSON handling. So far it has achieved that, and is about 2 times faster than any other Ruby JSON parser, and 3 or more times faster at serializing JSON.
...
* [JSON](https://github.com/flori/json) ⭐ 783 | 🐛 10 | 🌐 Ruby | 📅 2026-09-25 — includes pure Ruby and C implementation for JSON.
...
* [Statesman](https://github.com/gocardless/statesman) ⭐ 1,911 | 🐛 20 | 🌐 Ruby | 📅 2026-09-25 — an opinionated state machine library designed to provide a robust audit trail and data integrity. It decouples the state machine logic from the underlying model and allows for easy composition with one or more model classes.
...
* [Mustache](https://github.com/defunkt/mustache) ⭐ 3,086 | 🐛 44 | 🌐 Ruby | 📅 2026-08-20 — logic-less Ruby templates. A framework-agnostic way to render logic-free views.
...
* [factory\_bot](https://github.com/thoughtbot/factory_bot) ⭐ 8,170 | 🐛 83 | 🌐 Ruby | 📅 2026-08-21 — a fixtures replacement with a straightforward definition syntax, support for multiple build strategies (saved instances, unsaved instances, attribute hashes, and stubbed objects), and support for multiple factories for the same class, including factory inheritance.
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,276 | 🐛 64 | 🌐 Ruby | 📅 2026-09-23 — Rails integration for RSpec.
...
* [RSpec](https://github.com/rspec/rspec) ⭐ 117 | 🐛 169 | 🌐 Ruby | 📅 2026-09-03 — RSpec meta-gem that depends on the other components.

### Web Frameworks

* [Hanami](https://github.com/hanami/hanami) ⭐ 6,418 | 🐛 33 | 🌐 Ruby | 📅 2026-09-25 — a complete, modern web framework.
